        ...
        methods: {
            ...
            getAddressDetail(id) {
                this.$http.post('/userAddress/getOneAddrDateil', {
                    ...
                    this.address = res.data.province + ' ' + res.data.city + ' ' + res.data.area || ''; //这里返回 province ,city ,area指地区名称
                    this.province = res.data.provinceCode || '';
                    this.city = res.data.cityCode || '';
                    this.area = res.data.areaCode || '';
                })
            },
