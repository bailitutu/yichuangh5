    ...
    <yd-layout title="编辑地址" link="/addressList">
        <yd-cell-group class="mt-10">
            ...
            <yd-cell-item>
                ...
                <input slot="right" type="number" v-model="postalCode" placeholder="请输入邮编">
            </yd-cell-item>
        ...
        <yd-cityselect v-model="show2" :callback="selAddress" :items="district"></yd-cityselect>
        <div class="prl-10">
            <yd-button size="large" type="primary" bgcolor="#fff" color="#282828" @click.native="savahandler"> 保存</yd-button>
        </div>
        <div class="prl-10" v-if=" pageType == 0 ? false : true">
            <yd-button size="large" type="danger" class="mt-10" color="#fff" @click.native="delAddress"> 删除地址</yd-button>
        </div>
    </yd-layout>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            selAddress(ret) {
                ...
                // this.addressArr = [ ret.itemValue1,ret.itemValue2, ret.itemValue3 ]; //获取地址code
            },
            // 删除地址
            delAddress(){
                this.$dialog.confirm({
